...
export interface MockOracle extends BaseContract {
  ...
  floorPrice: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  setFloorPrice: TypedContractMethod<
    [nft: AddressLike, price: BigNumberish],
    [void],
    "nonpayable"
  >;
